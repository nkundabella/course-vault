<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>CourseVault | Forgot Password</title>
        ...
        <body>
            <div class="forgot-container">
                <div class="animation-area">
                    ...
                    <!-- Use a stable JSON source (lottie.host has been flaky) -->
                    <dotlottie-player
                ...
                <div class="form-area">
                    <div class="header">
                        ...
                        <p>Don't worry, it happens to the best of us. Let's get you back into your account.</p>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/auth/verify-identity" method="POST">
